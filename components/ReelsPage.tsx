...
interface ReelProps {
    ...
    onShare?: (reel: ReelType) => void;
    isVisible: boolean;
}

const Reel: React.FC<ReelProps> = ({ reel, onLikeReel, onOpenComments, onShare, isVisible }) => {
  ...
  const handleShareClick = () => onShare?.(reel);
...
export const ReelsPage: React.FC<ReelsPageProps> = ({ reels, onLikeReel, onOpenComments, onGenerateReel, onShare = () => {} }) => {
